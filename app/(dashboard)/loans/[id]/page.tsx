...
export default function LoanViewPage() {
  ...
  const [selectedGuarantors, setSelectedGuarantors] = useState<any[] | null>(null);
  ...
  const memberSummaries = useMemo(() => {
    ...
    return loan.group.members.map((m: any) => {
      ...
      const guarantors = loan.guarantors.filter((g: any) => g.clientId === m.clientId);
    ...
    <div className="flex flex-col gap-6 w-full md:px-4 pb-10 max-w-7xl mx-auto">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex gap-2">
           ...
           <Button variant="outline" className="gap-2 h-11 px-6 font-bold" onClick={() => router.push(`/loans/${id}/edit-schedule`)}>
              ...
              <CardHeader className="bg-muted/10 border-b flex flex-row items-center justify-between">
                <div>
                  <CardTitle className="text-xl font-bold flex items-center gap-2 text-slate-800">
                    <Users className="w-5 h-5 text-primary" /> Member Performance & Guarantors
                  </CardTitle>
                  ...
                  <Table>
                    <TableHeader>
                      <TableRow className="bg-muted/30 hover:bg-muted/30 border-b">
                        ...
                        <TableHead className="font-bold text-foreground text-right text-primary">Balance</TableHead>
